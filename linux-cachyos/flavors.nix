{ final, lib, pkgsLLVM, ltoVars, ltsVars, rcVars, serverVars, hardenedVars, mainVersions, ltsVersions, rcVersions, serverVersions, hardenedVersions, preventBuildingKernelModules }:
...
in
{
  gcc = {
    ...
    cachyVars = ltoVars // { "_use_llvm_lto" = "none"; };
    versions = mainVersions;
    updateConfig = { versionsFile = "versions.json"; suffix = ""; flavors = [ "-gcc" "-lto" ]; };
  };
  ...
  "lto-znver4" = ltoKernelAttrs // {
    ...
    cachyVars = ltoVars // { "_processor_opt" = "ZEN4"; };
    versions = mainVersions;
    updateConfig = { versionsFile = "versions.json"; suffix = ""; flavors = [ "-gcc" "-lto" ]; };
  ...
  lts = {
    ...
    updateConfig = { versionsFile = "versions-lts.json"; suffix = "-lts"; flavors = [ "-lts" ]; };
    packagesExtend = preventBuildingKernelModules;
  };
  ...
  rc = {
    ...
    cachyVars = rcVars // { "_use_llvm_lto" = "none"; };
    versions = rcVersions;
    updateConfig = { versionsFile = "versions-rc.json"; suffix = "-rc"; flavors = [ "-rc" ]; };
    packagesExtend = preventBuildingKernelModules;
  };
  ...
  server = {
    ...
    cachyVars = serverVars // { _preempt = "server"; _per_gov = "yes"; };
    versions = serverVersions;
    updateConfig = { versionsFile = "versions-server.json"; suffix = "-server"; flavors = [ "-server" ]; };
    withDAMON = true;
    withNTSync = false;
  ...
  hardened = {
    ...
    updateConfig = { versionsFile = "versions-hardened.json"; suffix = "-hardened"; flavors = [ "-hardened" ]; };
    withNTSync = false;
    withPrivateHDR = false;
    packagesExtend = preventBuildingKernelModules;
  };
